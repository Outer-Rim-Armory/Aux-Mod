...
1. If I delete this entire template or parts of it and go my own path, my issue will likely be closed without any message.
...
## Attachments
If applicable, add screenshots to help explain your problem. **At the bare minimum, include an RPT (log) file.**
