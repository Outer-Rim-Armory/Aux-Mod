class BNA_KC_EPF_Unit_Rifleman: BNA_KC_EPF_Unit_Base
{
    ...
    linkedItems[] = {"SC_Helmet_EN_Desert", "BNA_KC_EPF_Vest", BASE_LINKED_ITEMS};
    respawnLinkedItems[] = {"SC_Helmet_EN_Desert", "BNA_KC_EPF_Vest", BASE_LINKED_ITEMS};
...
class BNA_KC_EPF_Unit_AT: BNA_KC_EPF_Unit_Rifleman
{
    ...
    linkedItems[] = {"SC_Helmet_WP_EUD_Desert_V", "BNA_KC_EPF_Vest_AssaultMedium", BASE_LINKED_ITEMS};
    respawnLinkedItems[] = {"SC_Helmet_WP_EUD_Desert_V", "BNA_KC_EPF_Vest_AssaultMedium", BASE_LINKED_ITEMS};
...
class BNA_KC_EPF_Unit_AssaultHeavy: BNA_KC_EPF_Unit_Rifleman
{
    ...
    linkedItems[] = {"SC_Helmet_RN_Desert", "BNA_KC_EPF_Vest_AssaultHeavy", BASE_LINKED_ITEMS};
    respawnLinkedItems[] = {"SC_Helmet_RN_Desert", "BNA_KC_EPF_Vest_AssaultHeavy", BASE_LINKED_ITEMS};
...
class BNA_KC_EPF_Unit_AssaultMedium: BNA_KC_EPF_Unit_AssaultHeavy
{
    ...
    linkedItems[] = {"SC_Helmet_RN_Desert", "BNA_KC_EPF_Vest_AssaultMedium", BASE_LINKED_ITEMS};
    respawnLinkedItems[] = {"SC_Helmet_RN_Desert", "BNA_KC_EPF_Vest_AssaultMedium", BASE_LINKED_ITEMS};
...
class BNA_KC_EPF_Unit_SL: BNA_KC_EPF_Unit_Rifleman
{
    ...
    linkedItems[] = {"SC_Helmet_WD_Desert_V", "BNA_KC_EPF_Vest_Medium", BASE_LINKED_ITEMS};
    respawnLinkedItems[] = {"SC_Helmet_WD_Desert_V", "BNA_KC_EPF_Vest_Medium", BASE_LINKED_ITEMS};
...
class BNA_KC_EPF_Unit_Melee: BNA_KC_EPF_Unit_Base
{
    ...
    linkedItems[] = {"SC_Helmet_WP_Desert", "BNA_KC_EPF_Vest", BASE_LINKED_ITEMS};
    respawnLinkedItems[] = {"SC_Helmet_WP_Desert", "BNA_KC_EPF_Vest", BASE_LINKED_ITEMS};
