class CfgPatches
{
    class BNA_KC_INDEP_Galtorran
    {
        ...
        units[] =
        {
            ...
            "BNA_KC_Galtorran_Unit_AA",
            "BNA_KC_Galtorran_Unit_AA_T2",
            "BNA_KC_Galtorran_Unit_AA_T3",
