class CfgSounds {
    ...
    */
    ...
    SOUND(Crowd_Cheering,"[KC] Cheering Crowd","Cheering Crowd");
    SOUND(IdleAwards,"[KC] Idle Awards Opening","Idle Awards Opening");
    SOUND(Huntrix_Golden,"[KC] Huntrix Golden","Huntrix Golden");
