class CfgSFX {
    ...
    */
    SOUND_FX(Restaurant,"[KC] Restaurant Ambience",300);
    SOUND_FX(Incoming,"[KC] Incoming Alarm",400);
    SOUND_FX(Disturbance,"[KC] Disturbance in the forcee",150);
    SOUND_FX(JediWarning,"[KC] Jedi Warning",100);
    SOUND_FX(ATTE_Alarm,"[KC] AT-TE Alarm",400);
    SOUND_FX(DK_Radio,"[KC] DK Radio Chatter",100);
    SOUND_FX(CarnageRoar,"[KC] Carnage Roar",300);
    ...
    SOUND_FX(Godzilla_Roar,"[KC] Godzilla Roar",5000);
};