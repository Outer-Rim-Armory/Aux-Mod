...
class CfgWeapons {
    ...
    class CLASS(AquaB2Blaster_base): CLASS(E5_base) {
        displayName = "[KC] Dual Wrist Blaster (Base)";
        descriptionShort = "Built in repeating blaster";
        baseWeapon = QCLASS(B2Blaster_base);
    ...
    class CLASS(AquaB2Blaster): CLASS(AquaB2Blaster_base) {
        SCOPE_PUBLIC;
        displayName = "[KC] Aqua Dual Wrist Blaster";
        baseWeapon = QCLASS(AquaB2Blaster);
        canShootInWater = TRUE;
    };
