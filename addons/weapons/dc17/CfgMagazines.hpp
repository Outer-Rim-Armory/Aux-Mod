class CfgMagazines {
    ...
    class CLASS(Mag_20Rnd_DC17_Red): CLASS(Mag_Base) {
        SCOPE_PUBLIC;
        displayName = "[KC] DC-17 Energy Cell (Red)";
        displayNameShort = "Low Energy";
        descriptionShort = "Energy Cell Pack<br/>Rounds: 20<br/>Used In: DC-17";
        ...
        ammo = QCLASS(Bullet_PlasmaPistol_Red);
        count = 20;
        mass = 2;
        initSpeed = 430;
    };

    class CLASS(Mag_40Rnd_DC17_dual_Red): CLASS(Mag_20Rnd_DC17) {
        displayName = "[KC] DC-17 Dual Energy Cell (Red)";
        descriptionShort = "Energy Cell Pack<br/>Rounds: 40<br/>Used In: Dual DC-17";
    ...
    class CLASS(Mag_60Rnd_DC17_dualHP_Red): CLASS(Mag_40Rnd_DC17_dual) {
        displayName = "[KC] DC-17 HP Dual Energy Cell (Red)";
        displayNameShort = "Medium Energy";
        descriptionShort = "Energy Cell Pack<br/>Rounds: 60<br/>Used In: Commander/ARC Dual DC-17";

        ammo = QCLASS(Bullet_Plasma_DC17Dual_Red);
        count = 60;
        mass = 2;
        initSpeed = 430;
    };
