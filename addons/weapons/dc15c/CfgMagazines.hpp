class CfgMagazines {
    ...
    class CLASS(Mag_70Rnd_DC15C): CLASS(Mag_Base) {
        SCOPE_PUBLIC;
        displayName = "[KC] DC-15C Energy Cell (Blue)";
    ...
    class CLASS(Mag_70Rnd_DC15C_Red): CLASS(Mag_Base) {
        SCOPE_PUBLIC;
        displayName = "[KC] DC-15C Energy Cell (Red)";
        displayNameShort = "Standard Energy";
        descriptionShort = "Energy Cell Pack<br/>Rounds: 70<br/>Used In: DC-15C";
        ...
        ammo = QCLASS(Bullet_PlasmaCarbine_Red3);
        count = 70;
        mass = 10;
    };
};
