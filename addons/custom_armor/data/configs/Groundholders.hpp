...
GROUND_HOLDER(Helmet_Phase1_Rabble,"INF P1 Helm ('Rabble')");
...
GROUND_HOLDER(Helmet_Phase2_Rabble,"INF P1 Helm ('Rabble')");
...
GROUND_HOLDER(Helmet_BARC_Keeli_Worn,"INF BARC Helm ('Keeli') ('Worn')");
GROUND_HOLDER(Helmet_BARC_KeeliCrimson_Worn,"INF BARC Helm ('Keeli') ('Worn') [Crimson Visor]");
GROUND_HOLDER(Helmet_BARC_Lines,"INF BARC Helm ('Lines')");
