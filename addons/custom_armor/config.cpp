...
class CfgPatches {
    class ADDON {
        ...
        weapons[] = {
            ...
            QCLASS(Helmet_Phase2_ARMR_Catholic),
            QCLASS(Helmet_Phase2_ARMR_CatholicKyber),
            //QCLASS(Helmet_Phase2_ARMR_Grey),
            ...
            QCLASS(Helmet_ARC_Tyrant_On),
            QCLASS(Helmet_ARC_TyrantCrimson_On),
