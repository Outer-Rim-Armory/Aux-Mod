...
class CfgPatches {
    class ADDON {
        ...
        units[] = {
            ...
            QCLASS(Unit_RC_Tugz),
            QCLASS(Unit_RC_Jaws),
            QCLASS(Unit_RC_Jaws_Worn),
            QCLASS(Unit_RC_Cutthroat),
            ...
            QCLASS(Jaws_Backpack),
            QCLASS(Cutthroat_Backpack),
            QCLASS(Moskoni_Backpack),
            ...
            QGROUND_CLASS(Helmet_Phase2_Keeli_Worn),
            QGROUND_CLASS(Helmet_Phase2_KeeliCrimson_Worn),
            ...
            QGROUND_CLASS(Helmet_Sand_Keeli),
            QGROUND_CLASS(Helmet_Sand_KeeliCrimson)
        };
        weapons[] = {
            ...
            QCLASS(Helmet_Phase1_Maverick),
            QCLASS(Helmet_Phase1_Nate),
            ...
            QCLASS(Helmet_Phase2_Keeli_Worn),
            QCLASS(Helmet_Phase2_KeeliCrimson_Worn),
            ...
            QCLASS(Helmet_ARF_Tankers),
            QCLASS(Helmet_ARF_Tankers_Worn),
            ...
            QCLASS(Helmet_RC_Jaws),
            QCLASS(Helmet_RC_Jaws_Worn),
            QCLASS(Helmet_RC_Cutthroat),
            QCLASS(Helmet_RC_Moskoni),
            QCLASS(Uniform_Axel),
            QCLASS(Uniform_Bailout),
            QCLASS(Uniform_Bob),
            QCLASS(Uniform_Burnt),
            QCLASS(Uniform_Calvin),
            QCLASS(Uniform_Catholic),
            QCLASS(Uniform_Cough),
            QCLASS(Uniform_Cutthroat),
            QCLASS(Uniform_RC_Cutthroat),
            ...
            QCLASS(Uniform_Joe),
            QCLASS(Uniform_Jaws),
            QCLASS(Uniform_RC_Jaws),
            QCLASS(Uniform_Keeli),
            QCLASS(Uniform_Keeli_CamoBrown),
            QCLASS(Uniform_Keeli_CamoGrey),
            QCLASS(Uniform_Keeli_Worn),
            QCLASS(Uniform_Rat),
            QCLASS(Uniform_Rev),
            QCLASS(Uniform_Sin),
            QCLASS(Uniform_Sogi),
            QCLASS(Uniform_Splashdown),
            QCLASS(Uniform_Talyn),
            QCLASS(Uniform_Tankers),
            QCLASS(Uniform_Tankers_Worn),
            QCLASS(Uniform_Tugz),
            QCLASS(Uniform_RC_Tugz),
            QCLASS(Uniform_RC_Jaws),
            QCLASS(Uniform_RC_Jaws_Worn),
            QCLASS(Uniform_RC_Cutthroat),
            QCLASS(Uniform_RC_Moskoni),
