...
GROUND_HOLDER(Helmet_Phase1_Ponds,"INF P1 Helm ('Ponds')");
...
GROUND_HOLDER(Helmet_Phase2_Ponds,"INF P2 Helm ('Ponds')");
GROUND_HOLDER(Helmet_Phase2_Trooper187,"INF P2 Helm (187th Trooper)");
...
GROUND_HOLDER(Helmet_Phase2_Stone,"INF P2 Helm ('Stone')");
