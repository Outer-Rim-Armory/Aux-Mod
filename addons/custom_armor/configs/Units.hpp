...
class CLASS(Unit_Azen): CLASS(Unit_Phase2_Base) {
    displayName = "Azen";

    editorSubcategory = QEDSUBCAT(Customs);
    editorPreview = EDITOR_PREVIEW(Unit_Azen);

    uniformClass = QCLASS(Uniform_Azen);
    hiddenSelectionsTextures[] = {
        QPATHTOF(data\uniforms\standard\Azen_upper_co.paa),
        QPATHTOF(data\uniforms\standard\Azen_lower_co.paa),
        "\ls\core\addons\characters_clone_legacy\uniforms\phase2\data\undersuit_co.paa"
    };

    linkedItems[] = {
        QCLASS(Helmet_Phase2_Azen), QCLASS(Vest_Basic), "lsd_gar_p2Interior_hud", CLONE_LINKED_ITEMS_RADIO
    };
    respawnLinkedItems[] = {
        QCLASS(Helmet_Phase2_Azen), QCLASS(Vest_Basic), "lsd_gar_p2Interior_hud", CLONE_LINKED_ITEMS_RADIO
    };
...
class CLASS(Unit_Catholic): CLASS(Unit_Phase2_Base) {
    ...
    linkedItems[] = {
        QCLASS(Helmet_Phase2_ARMR_Catholic), QCLASS(Vest_ARMR_CT), QCLASS(cloneNvg_chip), QCLASS(Facewear_phase2_Pauldron), CLONE_LINKED_ITEMS_RADIO
    };
    respawnLinkedItems[] = {
        QCLASS(Helmet_Phase2_ARMR_Catholic), QCLASS(Vest_ARMR_CT), QCLASS(cloneNvg_chip), QCLASS(Facewear_phase2_Pauldron), CLONE_LINKED_ITEMS_RADIO
    };
...
class CLASS(Unit_Cough): CLASS(Unit_Phase2_Base) {
    ...
    linkedItems[] = {
        QCLASS(Helmet_ARC_Cough), QCLASS(cloneVest_arc_Cough), QCLASS(cloneNvg_chip), "lsd_gar_p2Interior_hud", CLONE_LINKED_ITEMS_RADIO
    };
    respawnLinkedItems[] = {
        QCLASS(Helmet_ARC_Cough), QCLASS(cloneVest_arc_Cough), QCLASS(cloneNvg_chip), "lsd_gar_p2Interior_hud", CLONE_LINKED_ITEMS_RADIO
    };
...
class CLASS(Unit_Dexus): CLASS(Unit_Phase2_Base) {
    ...
    linkedItems[] = {
        QCLASS(Helmet_BARC_Dexus), QCLASS(cloneVest_heavy_Dexus), QCLASS(cloneNvg_chip), "lsd_gar_p2Interior_hud", CLONE_LINKED_ITEMS_RADIO
    };
    respawnLinkedItems[] = {
        QCLASS(Helmet_BARC_Dexus), QCLASS(cloneVest_heavy_Dexus), QCLASS(cloneNvg_chip), "lsd_gar_p2Interior_hud", CLONE_LINKED_ITEMS_RADIO
    };
...
class CLASS(Unit_Evo): CLASS(Unit_Phase2_Base) {
    ...
    linkedItems[] = {
        QCLASS(Helmet_ARC_Evo), QCLASS(cloneVest_arc_Evo), QCLASS(cloneNvg_chip), "lsd_gar_p2Interior_hud", CLONE_LINKED_ITEMS_RADIO
    };
    respawnLinkedItems[] = {
        QCLASS(Helmet_ARC_Evo), QCLASS(cloneVest_arc_Evo), QCLASS(cloneNvg_chip), "lsd_gar_p2Interior_hud", CLONE_LINKED_ITEMS_RADIO
    };
...
class CLASS(Unit_Harry): CLASS(Unit_Phase2_Base) {
    ...
    linkedItems[] = {
        QCLASS(Helmet_ARC_Harry), QCLASS(cloneVest_arc_Harry), QCLASS(cloneNvg_phase2_rangefinder), "lsd_gar_p2Interior_hud", CLONE_LINKED_ITEMS_RADIO
    };
    respawnLinkedItems[] = {
        QCLASS(Helmet_ARC_Harry), QCLASS(cloneVest_arc_Harry), QCLASS(cloneNvg_phase2_rangefinder), "lsd_gar_p2Interior_hud", CLONE_LINKED_ITEMS_RADIO
    };
