class CLASS(Helmet_Phase2_ARMR_Base): CLASS(cloneHelmet_base) {
    SCOPE_PUBLIC;
...
class CLASS(Helmet_Phase2_ARMR_CT): CLASS(Helmet_Phase2_ARMR_Base) {
...
class CLASS(Helmet_Phase2_ARMR_SCT): CLASS(Helmet_Phase2_ARMR_CT) {
...
class CLASS(Helmet_Phase2_ARMR_VCT): CLASS(Helmet_Phase2_ARMR_CT) {
...
class CLASS(Helmet_Phase2_ARMR_NCO): CLASS(Helmet_Phase2_ARMR_CT) {
...
class CLASS(Helmet_Phase2_ARMR_Officer): CLASS(Helmet_Phase2_ARMR_CT) {
...
class CLASS(Helmet_Phase2_ARMR_Enlisted_CamoBrown): CLASS(Helmet_Phase2_ARMR_CT) {
...
class CLASS(Helmet_Phase2_ARMR_Enlisted_CamoGrey): CLASS(Helmet_Phase2_ARMR_CT) {
...
class CLASS(Helmet_Phase2_ARMR_Ceremonial): CLASS(Helmet_Phase2_ARMR_CT) {
    displayName = "[KC] ARMR P2 Helm (Ceremonial)";
    hiddenSelectionsTextures[] = {
        QPATHTOF(data\helmets\phase2SpecOp\Ceremonial_P2Reeker_camo1_co.paa),
        "\ls\core\addons\characters_clone_legacy\helmets\phase2SpecOp\data\visor_co.paa"
    };
};
