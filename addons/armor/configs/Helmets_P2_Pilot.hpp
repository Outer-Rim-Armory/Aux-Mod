...
class CLASS(Helmet_Phase2_Pilot_CXA_Empire): CLASS(Helmet_Phase2_Pilot_Base) {
...
class CLASS(Helmet_Phase2_Pilot_CXE_Empire): CLASS(Helmet_Phase2_Pilot_Base) {
    displayName = "[KC] AVI P2 Helm 06 (Ensign, Empire)";
    hiddenSelectionsTextures[] = {
        QPATHTOF(data\helmets\phase2Pilot\Imperial_CXE_camo1_co.paa),
        "\ls\core\addons\characters_clone_legacy\helmets\phase2Pilot\data\visor_co.paa"
    };
};
