...
class CLASS(Vest_Heavy_v2): CLASS(Vest_Heavy) { type = "Heavy_v2"; };
...
class CLASS(Vest_Officer_v2): CLASS(Vest_CLC) { rank = "Officer_v2"; };
class CLASS(Vest_WO): CLASS(Vest_CLC) { rank = "WO"; };
class CLASS(Vest_Commander): CLASS(Vest_CLC) { rank = "CMD"; };
class CLASS(Vest_Commander_v2): CLASS(Vest_CLC) { rank = "CMD_v2"; };
