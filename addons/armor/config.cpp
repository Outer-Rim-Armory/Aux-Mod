...
class CfgPatches {
    class ADDON {
        ...
        units[] = {
            ...
            QCLASS(Unit_Phase2_CXA_Imperial),
            QCLASS(Unit_Phase2_CXE_Imperial),
            QCLASS(Unit_Phase1_ARMR_CT),
            QCLASS(Unit_Phase2_ARMR_CT),
            QCLASS(Unit_ARC_CT),
            ...
            QCLASS(Unit_Scout_CT),
            QCLASS(Unit_Scout_Brown),
            QCLASS(Unit_Scout_Grey),
            QCLASS(Unit_Scout_Imperial),
            QCLASS(Unit_Phase2_Crocea),
            QCLASS(cloneBackpack_base),
            QCLASS(cloneBackpack_standard),
            QCLASS(Backpack),
            QCLASS(Backpack_Brown),
            QCLASS(Backpack_Gray),
            QCLASS(Backpack_Invis),
            QCLASS(Backpack_Heavy_Base),
            QCLASS(Backpack_Heavy),
            QCLASS(Backpack_Heavy_Brown),
            QCLASS(Backpack_Heavy_Gray),
            QCLASS(Backpack_Rocket_Base),
            QCLASS(Backpack_Rocket),
            QCLASS(Backpack_Rocket_Brown),
            QCLASS(Backpack_Rocket_Gray),
            QCLASS(Backpack_Radio_Base),
            QCLASS(Backpack_Radio),
            QCLASS(Backpack_Radio_Brown),
            QCLASS(Backpack_Radio_Gray),
            QCLASS(Backpack_Radio_Invis),
            QCLASS(Backpack_Medic_Base),
            QCLASS(Backpack_Medic),
            QCLASS(Backpack_Medic_Brown),
            QCLASS(Backpack_Medic_Gray),
            QCLASS(Backpack_Medic_Heavy_Base),
            QCLASS(Backpack_Medic_Heavy),
            QCLASS(Backpack_Medic_Heavy_Brown),
            QCLASS(Backpack_Medic_Heavy_Gray),
            QCLASS(Backpack_Medic_Radio_Base),
            QCLASS(Backpack_Medic_Radio),
            QCLASS(Backpack_Medic_Radio_Brown),
            QCLASS(Backpack_Medic_Radio_Gray),
            QCLASS(Backpack_Radio_Mini_Base),
            QCLASS(Backpack_Radio_Mini),
            QCLASS(Backpack_Radio_Mini_V2),
            QCLASS(Backpack_Radio_Mini_Brown),
            QCLASS(Backpack_Radio_Mini_Gray),
            QCLASS(Backpack_ARC),
            ...
            QCLASS(cloneBackpack_commando_EOD_Red),
            QCLASS(cloneBackpack_commando_RTO),
            QCLASS(cloneBackpack_commando_RTO_Red),
            QCLASS(cloneBackpack_commando_Tech),
            QCLASS(cloneBackpack_commando_Tech_Red),
            QCLASS(cloneBackpack_commando_ceremonial),
            QCLASS(Jetpack_JT12),
            QCLASS(Jetpack_JT12_Empire),
            QCLASS(Jetpack_JT12_LR),
            QCLASS(Jetpack_JT12_LR_Empire),
            QCLASS(Jetpack_CDV21),
            QCLASS(Jetpack_CDV21_LR),
            QCLASS(Jetpack_CDV19),
            QCLASS(Jetpack_CDV19_LR),
            QCLASS(Backpack_Radio_Crocea),
            ...
            QGROUND_CLASS(Helmet_Phase1_ARMR_Base),
            QGROUND_CLASS(Helmet_Phase1_ARMR_CT),
            QGROUND_CLASS(Helmet_Phase1_ARMR_CT_v2),
            ...
            QGROUND_CLASS(Helmet_Phase2_ARMR_Base),
            QGROUND_CLASS(Helmet_Phase2_ARMR_CT),
            QGROUND_CLASS(Helmet_Phase2_ARMR_CT_v2),
            QGROUND_CLASS(Helmet_Phase2_ARMR_Enlisted_CamoBrown),
            QGROUND_CLASS(Helmet_Phase2_ARMR_Enlisted_CamoGrey),
        ...
        weapons[] = {
            ...
            QCLASS(Helmet_Phase2_CR_Empire),
            QCLASS(Helmet_Phase2_CT),
            QCLASS(Helmet_Phase2_CT_v2),
            QCLASS(Helmet_Phase2_CT_Legacy),
            QCLASS(Helmet_Phase2_CT_Empire),
            QCLASS(Helmet_Phase2_SCT),
            QCLASS(Helmet_Phase2_SCT_Legacy),
            QCLASS(Helmet_Phase2_SCT_Empire),
            QCLASS(Helmet_Phase2_VCT),
            QCLASS(Helmet_Phase2_VCT_Legacy),
            QCLASS(Helmet_Phase2_VCT_Empire),
            QCLASS(Helmet_Phase2_CLC),
            QCLASS(Helmet_Phase2_CLC_Legacy),
            QCLASS(Helmet_Phase2_CLC_Empire),
            QCLASS(Helmet_Phase2_CPL),
            QCLASS(Helmet_Phase2_CPL_Empire),
            QCLASS(Helmet_Phase2_CS),
            QCLASS(Helmet_Phase2_CS_Legacy),
            QCLASS(Helmet_Phase2_CS_Empire),
            QCLASS(Helmet_Phase2_CSS),
            QCLASS(Helmet_Phase2_CSS_Empire),
            QCLASS(Helmet_Phase2_CSFC),
            QCLASS(Helmet_Phase2_CSFC_Empire),
            QCLASS(Helmet_Phase2_CMS),
            QCLASS(Helmet_Phase2_CMS_Legacy),
            QCLASS(Helmet_Phase2_CMS_Empire),
            QCLASS(Helmet_Phase2_CSM),
            QCLASS(Helmet_Phase2_CSM_Empire),
            QCLASS(Helmet_Phase2_Officer),
            QCLASS(Helmet_Phase2_WO),
            QCLASS(Helmet_Phase2_WO_Empire),
            QCLASS(Helmet_Phase2_WO2),
            QCLASS(Helmet_Phase2_WO2_Empire),
            QCLASS(Helmet_Phase2_WO3),
            QCLASS(Helmet_Phase2_WO3_Empire),
            QCLASS(Helmet_Phase2_CL),
            QCLASS(Helmet_Phase2_CL_Empire),
            QCLASS(Helmet_Phase2_CL1),
            QCLASS(Helmet_Phase2_CL1_Empire),
            QCLASS(Helmet_Phase2_CT_Medic),
            QCLASS(Helmet_Phase2_CS_Medic),
            QCLASS(Helmet_Phase2_WO_Medic),
            QCLASS(cloneArmor_helmet_phase2_textureTest),
            ...
            QCLASS(Helmet_ARC_Enlisted_Imperial),
            ...
            QCLASS(Helmet_Airborne_CT_Imperial),
            ...
            QCLASS(Helmet_Engineer_Imperial),
            ...
            QCLASS(Helmet_Phase2_Pilot_CXA_Empire),
            QCLASS(Helmet_Phase2_Pilot_CXE_Empire),
            ...
            QCLASS(Helmet_Phase1_ARMR_Base),
            QCLASS(Helmet_Phase1_ARMR_CT),
            QCLASS(Helmet_Phase1_ARMR_SCT),
            QCLASS(Helmet_Phase1_ARMR_VCT),
            QCLASS(Helmet_Phase1_ARMR_NCO),
            QCLASS(Helmet_Phase1_ARMR_Officer),
            QCLASS(Helmet_Phase1_ARMR_Ceremonial),
            QCLASS(Helmet_Phase2_ARMR_Base),
            QCLASS(Helmet_Phase2_ARMR_CT),
            QCLASS(Helmet_Phase2_ARMR_SCT),
            QCLASS(Helmet_Phase2_ARMR_VCT),
            QCLASS(Helmet_Phase2_ARMR_NCO),
            QCLASS(Helmet_Phase2_ARMR_Officer),
            QCLASS(Helmet_Phase2_ARMR_Enlisted_CamoBrown),
            QCLASS(Helmet_Phase2_ARMR_Enlisted_CamoGrey),
            QCLASS(Helmet_Phase2_ARMR_Imperial),
            QCLASS(Helmet_Phase2_ARMR_Ceremonial),
            QCLASS(cloneCommando_helmet),
            QCLASS(cloneCommando_helmet_red),
            QCLASS(ceremonial_cloneCommando_helmet),
            ...
            QCLASS(Helmet_Scout_CT_V2),
            QCLASS(Helmet_Scout_Brown),
            QCLASS(Helmet_Scout_Brown_V2),
            QCLASS(Helmet_Scout_Grey),
            QCLASS(Helmet_Scout_Grey_V2),
            QCLASS(Helmet_Scout_Imperial),
            QCLASS(Helmet_Scout_Imperial_V2),
            QCLASS(Helmet_Hunter_Base),
            QCLASS(Helmet_Crosshair_Base),
            QCLASS(Helmet_Phase1_Crocea),
            QCLASS(Helmet_Phase2_Crocea),
            QCLASS(Helmet_Phase1_Hologram),
            QCLASS(Helmet_Phase2_Hologram),
            QCLASS(Uniform_Base),
            ...
            QCLASS(Uniform_phase1Geo_Major),
            QCLASS(Uniform_phase1Geo_Commander),
            QCLASS(Uniform_CR),
            QCLASS(Uniform_CR_female),
            QCLASS(Uniform_CR_Empire),
            QCLASS(Uniform_CR_female_Empire),
            QCLASS(Uniform_CT),
            QCLASS(Uniform_CT_female),
            QCLASS(Uniform_CT_Legacy),
            QCLASS(Uniform_CT_Empire),
            QCLASS(Uniform_CT_female_Empire),
            QCLASS(Uniform_CT_Prison),
            QCLASS(Uniform_SCT),
            QCLASS(Uniform_SCT_female),
            QCLASS(Uniform_SCT_Empire),
            QCLASS(Uniform_SCT_Prison),
            QCLASS(Uniform_SCT_female_Empire),
            QCLASS(Uniform_VCT),
            QCLASS(Uniform_VCT_female),
            QCLASS(Uniform_VCT_Empire),
            QCLASS(Uniform_VCT_Prison),
            QCLASS(Uniform_VCT_female_Empire),
            QCLASS(Uniform_CLC),
            QCLASS(Uniform_CLC_Empire),
            QCLASS(Uniform_CPL),
            QCLASS(Uniform_CPL_Empire),
            QCLASS(Uniform_CS),
            QCLASS(Uniform_CS_Empire),
            QCLASS(Uniform_CSS),
            QCLASS(Uniform_CSS_Empire),
            QCLASS(Uniform_CSFC),
            QCLASS(Uniform_CSFC_Empire),
            QCLASS(Uniform_CMS),
            QCLASS(Uniform_CMS_Empire),
            QCLASS(Uniform_CSM),
            QCLASS(Uniform_CSM_Empire),
            QCLASS(Uniform_WO),
            QCLASS(Uniform_WO_Empire),
            QCLASS(Uniform_WO2),
            QCLASS(Uniform_WO2_Empire),
            QCLASS(Uniform_WO3),
            QCLASS(Uniform_WO3_Empire),
            QCLASS(Uniform_CL),
            QCLASS(Uniform_CL_Empire),
            QCLASS(Uniform_CL1),
            QCLASS(Uniform_CL1_Empire),
            QCLASS(Uniform_CT_Medic),
            QCLASS(Uniform_CS_Medic),
            QCLASS(Uniform_WO_Medic),
            ...
            QCLASS(Uniform_CXA),
            QCLASS(Uniform_CXE),
            QCLASS(Uniform_CXA_Empire),
            QCLASS(Uniform_CXE_Empire),
            ...
            QCLASS(Vest_ARC_Phase1Geo_Enlisted),
            QCLASS(Vest_ARC_Phase1Geo_NCO),
            QCLASS(Vest_ARC_Phase1Geo_Officer),
            QCLASS(Vest_ARC_Phase1Geo_Captain),
            QCLASS(Vest_ARC_Phase1Geo_Major),
            QCLASS(Vest_ARC_Phase1Geo_Commander),
            QCLASS(Ceremonial_Uniform),
            QCLASS(cloneCommando_uniform),
            QCLASS(Ceremonial_cloneCommando_uniform),
            QCLASS(Uniform_Jedi_Knight),
            QCLASS(Uniform_Jedi_Commander),
            QCLASS(Uniform_Scout_CT),
            QCLASS(Uniform_Scout_Brown),
            QCLASS(Uniform_Scout_Grey),
            QCLASS(Uniform_Scout_Imperial),
            QCLASS(Crocea_Uniform),
            QCLASS(Hologram_Uniform),
            QCLASS(Vest_Basic),
            QCLASS(Vest_Basic2),
            QCLASS(Vest_ARF),
            QCLASS(Vest_ForceRecon),
            QCLASS(Vest_ForceRecon_NCO),
            QCLASS(Vest_ForceRecon_Officer),
            QCLASS(Vest_Holster),
            QCLASS(Vest_Assault),
            ...
            QCLASS(Vest_Hazard),
            QCLASS(Vest_CLC),
            QCLASS(Vest_CLC_Empire),
            QCLASS(Vest_CPL),
            QCLASS(Vest_CPL_Empire),
            QCLASS(Vest_CS),
            QCLASS(Vest_CS_Empire),
            QCLASS(Vest_CSS),
            QCLASS(Vest_CSS_Empire),
            QCLASS(Vest_CSFC),
            QCLASS(Vest_CSFC_Empire),
            QCLASS(Vest_CMS),
            QCLASS(Vest_CMS_Empire),
            QCLASS(Vest_CSM),
            QCLASS(Vest_CSM_Empire),
            QCLASS(Vest_Officer),
            QCLASS(Vest_Officer_v2),
            QCLASS(Vest_Officer_Hologram),
            QCLASS(Vest_Officer_Imperial),
            QCLASS(Vest_Officer_Crocea),
            QCLASS(Vest_WO),
            QCLASS(Vest_WO_Empire),
            QCLASS(Vest_Kama),
            ...
            QCLASS(Vest_Airborne_Medic),
            QCLASS(Vest_Airborne_Medic_v2),
            ...
            QCLASS(Vest_ARMR_CS),
            QCLASS(Vest_ARMR_WO),
            QCLASS(Vest_ARMR_CT_Empire),
            QCLASS(Vest_ARMR_CS_Empire),
            QCLASS(Vest_ARMR_WO_Empire),
            QCLASS(Vest_ARC),
            ...
            QCLASS(cloneCommando_Hood_vest),
            QCLASS(cloneCommando_Hood_Black_vest),
            QCLASS(cloneCommando_Hood_Grey_vest),
            QCLASS(cloneCommando_Hood_Brown_vest),
            QCLASS(cloneNvg_chip),
            QCLASS(cloneNvg_phase1_visor),
            QCLASS(cloneNvg_phase1_visor_brown),
            QCLASS(cloneNvg_phase1_visor_gray),
            QCLASS(cloneNvg_phase2_visor),
            QCLASS(cloneNvg_phase2_visor_brown),
            QCLASS(cloneNvg_phase2_visor_gray),
            QCLASS(cloneNvg_phase2_visor_v2),
            QCLASS(cloneNvg_phase1_rangefinder),
            QCLASS(cloneNvg_phase1_rangefinder_brown),
            QCLASS(cloneNvg_phase1_rangefinder_gray),
            QCLASS(cloneNvg_phase2_rangefinder),
            QCLASS(cloneNvg_phase2_rangefinder_brown),
            QCLASS(cloneNvg_phase2_rangefinder_gray),
            QCLASS(cloneNvg_phase1_officerVisor),
            QCLASS(cloneNvg_phase1_officerVisor_brown),
            QCLASS(cloneNvg_phase1_officerVisor_gray),
            QCLASS(cloneNvg_phase2_officerVisor),
            QCLASS(cloneNvg_phase2_officerVisor_Brown),
