...
class CfgPatches {
    class ADDON {
        ...
        weapons[] = {
            ...
            QCLASS(Helmet_Phase1_Tanker_SCT),
            QCLASS(Helmet_Phase1_Tanker_VCT),
            QCLASS(Helmet_Phase1_Tanker_NCO),
            QCLASS(Helmet_Phase1_Tanker_Officer),
            QCLASS(Helmet_Phase2_Tanker_Base),
            QCLASS(Helmet_Phase2_Tanker_CT),
            QCLASS(Helmet_Phase2_Tanker_SCT),
            QCLASS(Helmet_Phase2_Tanker_VCT),
            QCLASS(Helmet_Phase2_Tanker_NCO),
            QCLASS(Helmet_Phase2_Tanker_Officer),
