        ...
        class CLASS(Faction_EPF) {
            ...
            class CLASS(EPF_Infantry) {
                ...
                class RifleSquad {
                    ...
                    class Object0 {
                        side = 0;
                        vehicle = QCLASS(EPF_Unit_SL);
                        rank = "SERGEANT";
                        position[] = {0, 0, 0};
                        dir = 0;
                    };
                    class Object1: Object0 {
                        vehicle = QCLASS(EPF_Unit_Rifleman);
                        rank = "Private";
                        position[] = {5, -5, 0};
                    };
                ...
                class AssaultSquad: RifleSquad {
                    ...
                    class Object2: Object2 {};
                    class Object3: Object3 {
                        vehicle = QCLASS(EPF_Unit_AssaultMedium);
                    };
                    class Object4: Object4 {
                        vehicle = QCLASS(EPF_Unit_AssaultMedium);
                    };
                    class Object5: Object5 {
                        vehicle = QCLASS(EPF_Unit_AssaultHeavy);
                    };
                    class Object6: Object6 {
                        vehicle = QCLASS(EPF_Unit_AssaultHeavy);
                    };
