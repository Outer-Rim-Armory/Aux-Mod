class CfgMagazines
{
	...
	class BNA_KC_Datapad_Mag_Base: CA_LauncherMagazine
	{
		// type = "3*		256";
	    author = "JRY";
	    scope = 0;
...
/*     class BNA_KC_Datapad_Mag_104thTest: BNA_KC_Datapad_Mag_Base
	{
	    ...
	    useAction = 0;
        count = 1;
	    displayName = "[KC] Datapad Cartridge (104th Dropcrate)";
	    descriptionShort = "Datapad Cartidge Type: 104th Dropcrate<br />Rounds: 1<br />Used in: Datapad";
	}; */
};
