...

{
    ...
    _vest = switch (_x) do {
        ...
        case "WO2": {QCLASS(Vest_WO)};
        case "WO3": {QCLASS(Vest_WO)};
        case "LT": {QCLASS(Vest_Officer)};
        case "1LT": {QCLASS(Vest_Officer)};
        case "CAP": {QCLASS(Vest_Officer)};
        case "MAJ": {QCLASS(Vest_Commander)};
        case "COM": {QCLASS(Vest_Commander)};
        default {QCLASS(Vest_Basic)};
    };

    _nvg = switch (true) do {
        case (_x in [LOADOUTS_RANKS_NCO]): {QCLASS(NVG_phase2_Rangefinder)};
        case (_x in [LOADOUTS_RANKS_OFFICER]): {QCLASS(NVG_phase2_Officer)};
