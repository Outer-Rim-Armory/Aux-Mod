class CfgVehicles
{
    ...
    class CLASS(LAATi_Base): 3AS_LAAT_Base
    {
        ...
        textureList[] = {"Standard", 0, "Imperial", 0, "KeeliCompany", 1, "KeeliCompany2", 1, "Akali", 0, "TwiLek", 0, "Katarima", 0};
        class TextureSources
        {
            ...
            class Katarima: KeeliCompany
            {
                displayName = "Katarima";
                textures[] =
                {
                    QPATHTOF(air\laati\data\textures\Katarima\Hull_co.paa),
                    QPATHTOF(air\laati\data\textures\Katarima\Wings_co.paa),
                    "\3AS\3as_Laat\LAATI\data\Weapons_CO.paa",
                    "\3AS\3as_Laat\LAATI\data\Weapon_Details_CO.paa",
                    "\3AS\3as_Laat\LAATI\data\Interior_CO.paa"
                };
