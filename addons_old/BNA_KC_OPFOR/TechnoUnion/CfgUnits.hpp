class BNA_KC_TU_Unit_Rifleman: BNA_KC_TU_Unit_Base
{
    ...
    linkedItems[] = {"BNA_KC_TU_Helmet", "BNA_KC_TU_Vest", LINKED_ITEMS_RADIO};
    respawnLinkedItems[] = {"BNA_KC_TU_Helmet", "BNA_KC_TU_Vest", LINKED_ITEMS_RADIO};
...
class BNA_KC_TU_Unit_AT: BNA_KC_TU_Unit_Rifleman
{
    ...
    linkedItems[] = {"BNA_KC_TU_Helmet_Visor_Goggles", "BNA_KC_TU_Vest_AssaultMedium", LINKED_ITEMS_RADIO};
    respawnLinkedItems[] = {"BNA_KC_TU_Helmet_Visor_Goggles", "BNA_KC_TU_Vest_AssaultMedium", LINKED_ITEMS_RADIO};
...
class BNA_KC_TU_Unit_AssaultHeavy: BNA_KC_TU_Unit_Rifleman
{
    ...
    linkedItems[] = {"BNA_KC_TU_Helmet_Assault", "BNA_KC_TU_Vest_AssaultHeavy", LINKED_ITEMS_RADIO};
    respawnLinkedItems[] = {"BNA_KC_TU_Helmet_Assault", "BNA_KC_TU_Vest_AssaultHeavy", LINKED_ITEMS_RADIO};
...
class BNA_KC_TU_Unit_AssaultMedium: BNA_KC_TU_Unit_AssaultHeavy
{
    ...
    linkedItems[] = {"BNA_KC_TU_Helmet_Assault", "BNA_KC_TU_Vest_AssaultMedium", LINKED_ITEMS_RADIO};
    respawnLinkedItems[] = {"BNA_KC_TU_Helmet_Assault", "BNA_KC_TU_Vest_AssaultMedium", LINKED_ITEMS_RADIO};
...
class BNA_KC_TU_Unit_SL: BNA_KC_TU_Unit_Rifleman
{
    ...
    linkedItems[] = {"BNA_KC_TU_Helmet_Heavy", "BNA_KC_TU_Vest_Medium", LINKED_ITEMS_RADIO};
    respawnLinkedItems[] = {"BNA_KC_TU_Helmet_Heavy", "BNA_KC_TU_Vest_Medium", LINKED_ITEMS_RADIO};
...
class BNA_KC_TU_Unit_Melee: BNA_KC_TU_Unit_Base
{
    ...
    linkedItems[] = {"BNA_KC_TU_Helmet_Visor", "BNA_KC_TU_Vest", LINKED_ITEMS_RADIO};
    respawnLinkedItems[] = {"BNA_KC_TU_Helmet_Visor", "BNA_KC_TU_Vest", LINKED_ITEMS_RADIO};
