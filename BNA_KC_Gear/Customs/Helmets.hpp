...
class BNA_KC_Helmet_Phase2_Sogi: BNA_KC_Helmet_Phase2_Base
{
...
class BNA_KC_Helmet_Phase2_Tyrant: BNA_KC_Helmet_Phase2_Base
{
    ...
    BNAKC_Helmet_On  = "BNA_KC_Helmet_Phase2_Tyrant_Plasma";
...
class BNA_KC_Helmet_Phase2_Tyrant_Plasma: BNA_KC_Helmet_Phase2_Tyrant
{
    // Scopes
	scope = 1;
    scopeArsenal = 1;

    displayName = "[KC] INF P2 Helm ('Tyrant) [Plasma Visor]";
    hiddenSelectionsMaterials[] =
    {
        "",
        "\a3\characters_f_bootcamp\common\data\vrarmoremmisive.rvmat"
...
class BNA_KC_Helmet_ARC_Tyrant: BNA_KC_Helmet_ARC
{
    ...
    BNAKC_Helmet_On  = "BNA_KC_Helmet_ARC_Tyrant_Plasma";
...
class BNA_KC_Helmet_ARC_Tyrant_Plasma: BNA_KC_Helmet_ARC_Tyrant
{
    // Scopes
    scope = 1;
    scopeArsenal = 1;

    displayName = "[KC] SF ARC Helm ('Tyrant') [Plasma Visor]";
    hiddenSelectionsMaterials[] =
    {
        "",
        "\a3\characters_f_bootcamp\common\data\vrarmoremmisive.rvmat"
