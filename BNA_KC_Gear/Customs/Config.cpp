...
class CfgWeapons
{
    ...
    class BNA_KC_Vest_Officer_Keeli: BNA_KC_Vest_Officer
    {
        ...
        {
            "\BNA_KC_Gear\Customs\Data\Textures\Vests\BNA_KC_Vest_Officer_Keeli.paa"
        };
    };
    class BNA_KC_Vest_Officer_Ponds: BNA_KC_Vest_Officer
    {
        ...
        hiddenSelectionsTextures[] =
        {
            "\BNA_KC_Gear\Customs\Data\Textures\Vests\BNA_KC_Vest_Officer_Ponds.paa"
        };
    ...
    class BNA_KC_Vest_Officer_Rat: BNA_KC_Vest_Officer
    {
        ...
        hiddenSelectionsTextures[] =
        {
            "\BNA_KC_Gear\Customs\Data\Textures\Vests\BNA_KC_Vest_Officer_Rat.paa"
        };
    };
    ...
    class BNA_KC_NVG_Officer_Keeli: BNA_KC_NVG_Officer
    {
        ...
        hiddenSelectionsTextures[] =
        {
            "\BNA_KC_Gear\Customs\Data\Textures\NVGs\BNA_KC_NVG_Officer_Keeli.paa"
        };
    };
};
...
class CfgVehicles
{
    ...
    class BNA_KC_Backpack_Keeli: BNA_KC_Backpack
    {
        ...
        hiddenSelectionsTextures[] =
        {
            "\BNA_KC_Gear\Customs\Data\Textures\Backpacks\BNA_KC_Backpack_Keeli.paa", // Main Texture
            "\BNA_KC_Gear\Customs\Data\Textures\Backpacks\BNA_KC_Backpack_Keeli.paa", // Cover
            "",                                                             // Heavy
            "",                                                             // Medic
            ""                                                              // RTO
        };
