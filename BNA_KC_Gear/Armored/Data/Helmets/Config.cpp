...
class CfgWeapons
{
    ...
    class BNA_KC_Helmet_Phase2_Pilot_Base: ls_gar_phase2Pilot_helmet
    {
        ...
        displayName = "[KC] AVI Helm 01 (Base)";
        hiddenSelectionsTextures[] =
        {
...
class CfgVehicles
{
    ...
    class BNA_KC_Unit_Phase1_Pilot: BNA_KC_Unit_Phase1_Base
    {
        ...
        linkedItems[] =
        {
            "BNA_KC_Helmet_Phase1_Pilot_Base", "lsd_gar_clone_vest", "BNA_KC_NVG_Chip", "lsd_gar_p2Interior_hud", "ItemMap", "SWLB_comlink", "ItemCompass", "tf_microdagr"
        };
        respawnLinkedItems[] =
        {
            "BNA_KC_Helmet_Phase1_Pilot_Base", "lsd_gar_clone_vest", "BNA_KC_NVG_Chip", "lsd_gar_p2Interior_hud", "ItemMap", "SWLB_comlink", "ItemCompass", "tf_microdagr"
    ...
    class BNA_KC_Unit_Phase2_Pilot: BNA_KC_Unit_Phase1_Pilot
    {
        ...
        linkedItems[] =
        {
            "BNA_KC_Helmet_Phase2_Pilot_Base", "lsd_gar_clone_vest", "BNA_KC_NVG_Chip", "lsd_gar_p2Interior_hud", "ItemMap", "SWLB_comlink", "ItemCompass", "tf_microdagr"
        };
        respawnLinkedItems[] =
        {
            "BNA_KC_Helmet_Phase2_Pilot_Base", "lsd_gar_clone_vest", "BNA_KC_NVG_Chip", "lsd_gar_p2Interior_hud", "ItemMap", "SWLB_comlink", "ItemCompass", "tf_microdagr"
