...
HELMET_HOLDER(BNA_KC_HelmetHolder_P1_CLC, [KC] INF P1 Helm 04 (Lance Corporal Trooper), BNA_KC_Helmet_Phase1_CLC, "P1")
...
HELMET_HOLDER(BNA_KC_HelmetHolder_P2_CLC, [KC] INF P2 Helm 04 (Lance Corporal Trooper), BNA_KC_Helmet_Phase2_CLC, "P2")
HELMET_HOLDER(BNA_KC_HelmetHolder_P2_CLC_Legacy, [KC] INF P2 Helm 04 (Lance Corporal Trooper, Legacy), BNA_KC_Helmet_Phase2_CLC_Legacy, "P2")
